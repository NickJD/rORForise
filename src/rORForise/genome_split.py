...
def generate_synthetic_reads(sequences, cds_annotations, read_length=150, coverage=10,
                             ...
                             fragment_size_mean=500, fragment_size_std=30):
...
def main():
    ...
    parser.add_argument('--fragment_size_mean', type=int, default=500,
                        help="Mean fragment size for paired-end simulation")
    parser.add_argument('--fragment_size_std', type=int, default=30,
