...
reads_in = open('/home/nick/Git/GeneFragValidator/Genome_Processing/Staph/Processing/ART_Simulated_Reads/Staph_ART_errFree_paired.fasta', 'r')

predictions_fasta = open('./Staph_Naive_Duo.fa','w')
predictions_gff = open('./Staph_Naive_Duo.gff','w')
